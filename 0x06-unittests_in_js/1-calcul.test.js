...
describe('calculateNumber', () => {
  ...
  describe('type == "DIVIDE"', () => {
    ...
    it('positive number and 0', () => {
      expect(() => calculateNumber('DIVIDE', 5.0, 0)).to.throw('Error');
    });

    it('positive number and number rounded down to 0', () => {
      expect(() => calculateNumber('DIVIDE', 5.0, 0.2)).to.throw('Error');
    });
    ...
    it('0 and 0', () => {
      expect(() => calculateNumber('DIVIDE', 0.0, 0.0)).to.throw('Error');
    });
  });
});
